...
class OrdinarClients extends StatefulWidget {
  const OrdinarClients({Key? key}) : super(key: key);

  @override
  State<OrdinarClients> createState() => _OrdinarClientsState();
}

class _OrdinarClientsState extends State<OrdinarClients> {
          ...
          child: ListView(
            ...
            children: [
              FirebaseAnimatedList(
                query: clientsController.queryClientsOrdinary(),
                reverse: true,
                shrinkWrap: true,
