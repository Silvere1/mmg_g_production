...
class EmployeeDash extends StatefulWidget {
  ...
  @override
  _EmployeeDashState createState() => _EmployeeDashState();
}
      ...
      child: Column(
        children: [
          FirebaseAnimatedList(
              query: venteController.queryAgenceInventaire0ne(
                  appServices.user == null
                      ? userController.user!.agenceId!
                      : appServices.user!.agenceId!),
              shrinkWrap: true,
          ...
          Dimensions.y28,
          FirebaseAnimatedList(
              query: stockController.getAgenceStockEmployee(
                  appServices.user == null
                      ? userController.user!.agenceId!
                      : appServices.user!.agenceId!),
              shrinkWrap: true,
