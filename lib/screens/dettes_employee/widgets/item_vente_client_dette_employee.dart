...
import '../../ventes_employee/ui/detail_vente_employee.dart';

class ItemVenteClientDetteEmployee extends StatefulWidget {
  const ItemVenteClientDetteEmployee({Key? key, required this.vente})
      : super(key: key);
  final Vente vente;

  @override
  State<ItemVenteClientDetteEmployee> createState() =>
      _ItemVenteClientDetteEmployeeState();
}

class _ItemVenteClientDetteEmployeeState
    extends State<ItemVenteClientDetteEmployee> {
                      ...
                      children: [
                        ...
                        Wrap(
                          ...
                          children: [
                            ...
                            if (widget.vente.netPayer - widget.vente.payer != 0)
                              const SizedBox(
                                height: 14,
                            ...
                            if (widget.vente.netPayer - widget.vente.payer != 0)
                              Text(
                                setMoney(
                                    widget.vente.netPayer - widget.vente.payer),
                                ...
                                if (widget.vente.portables != null)
                                  Wrap(
                                    ...
                                    children: [
                                      ...
                                      Text("${widget.vente.portables!.length}",
                                          style: Theme.of(context)
                                              .textTheme
                                              .headline3),
                                    ],
