...
import '/screens/stock/widgets/item_acc_stock_search.dart';
import '/screens/stock/widgets/item_phone_stock.dart';
import '/screens/stock/widgets/item_phone_stock_search.dart';
import '../../../res/assets_files.dart';

class GlobalStock extends StatefulWidget {
  const GlobalStock({Key? key}) : super(key: key);

  @override
  State<GlobalStock> createState() => _GlobalStockState();
}
                ...
                if (stockM.nbrPhone > 0)
                  ExpansionTile(
                    ...
                    children: [
                                ...
                                ? TypeAheadField<Phone>(
                                    ...
                                    suggestionsCallback: (pattern) async {
                                      return await stockController
                                          .getPhoneGlobalSearch(pattern.trim());
                                    },
                      ...
                      FirebaseAnimatedList(
                          query: stockController.getGlobalPhoneStock(),
                          reverse: true,
                          shrinkWrap: true,
                          physics: const BouncingScrollPhysics(),
                          padding: const EdgeInsets.symmetric(vertical: 8),
                ...
                if (stockM.nbrAcc > 0)
                  ExpansionTile(
                    ...
                    children: [
                          ...
                          child: AnimatedContainer(
                            ...
                            child: openSearchAcc
                                ? TypeAheadField<Acc>(
                                    ...
                                    suggestionsCallback: (pattern) async {
                                      return await stockController
                                          .getAccGlobalSearch(pattern.trim());
                                    },
                                    suggestionsBoxDecoration:
                                        SuggestionsBoxDecoration(
                                      borderRadius: BorderRadius.circular(10),
                      ...
                      FirebaseAnimatedList(
                          query: stockController.getGlobalAccStock(),
                          reverse: true,
                          shrinkWrap: true,
                          physics: const BouncingScrollPhysics(),
                          padding: const EdgeInsets.symmetric(vertical: 8),
