...
import '/screens/ventes_employee/components/cancel_vente.dart';
import '/screens/ventes_employee/widgets/item_update_vente.dart';
import '/screens/ventes_employee/widgets/item_vente_article.dart';
import '/screens/ventes_employee/widgets/item_vente_portable.dart';
import '../../../app/services/call/call.dart';
import '../../../res/assets_files.dart';

class DetailVenteEmployee extends StatefulWidget {
  const DetailVenteEmployee({Key? key, required this.vente}) : super(key: key);
  final Vente vente;

  @override
  State<DetailVenteEmployee> createState() => _DetailVenteEmployeeState();
}

class _DetailVenteEmployeeState extends State<DetailVenteEmployee> {
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            ListView.builder(
                              ...
                              shrinkWrap: true,
                              physics: const NeverScrollableScrollPhysics(),
                              itemBuilder: (_, i) => ItemVentePortable(
                                  vente: vente,
                                  hasDette: vente.hasDette,
                            ...
                            () => ElevatedButton(
                                onPressed: !venteController.cirC.value
                                    ? () async {
                                        ...
                                        //venteController.cancelAVente(vente, "raison");
                                      }
                                    : null,
