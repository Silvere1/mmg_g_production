...
import '/screens/ventes_employee/widgets/item_vente_employee_searche.dart';
import '../../../app/models/vente.dart';
import '../../../res/assets_files.dart';
import '../widgets/item_vente_employee.dart';
import 'detail_vente_employee.dart';

class VenteDayEmployee extends StatefulWidget {
  const VenteDayEmployee({Key? key, required this.day, required this.agenceId})
      : super(key: key);
  final String day;
  final String agenceId;

  @override
  State<VenteDayEmployee> createState() => _VenteDayEmployeeState();
}

class _VenteDayEmployeeState extends State<VenteDayEmployee> {
          ...
          children: [
                  ...
                  child: openSearch
                      ? TypeAheadField<Vente>(
                          ...
                          onSuggestionSelected: (suggestion) async {
                            ...
                            Get.to(
                                () => DetailVenteEmployee(vente: suggestion));
                          },
                        )
                      : ClipRRect(
                          borderRadius: BorderRadius.circular(10),
            ...
            FirebaseAnimatedList(
              ...
              itemBuilder: (_, snapshot, anim, i) {
                ...
                return ItemVenteEmployee(anim: anim, vente: vente);
              },
            ),
          ],
        ),
